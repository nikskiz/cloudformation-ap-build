 ...
 * Unfortunately, didn't have time to redirect HTTP to HTTPS as this requires ACM and route53, otherwise redirecting HTTP to HTTPS on a default loadbalancer will show a certificate error.
